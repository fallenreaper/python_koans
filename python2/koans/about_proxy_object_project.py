...
class Proxy(object):
    ...
    def messages(self): return self._events
    def was_called(self, attr_name): return attr_name in self.messages()
    def number_of_times_called(self, attr_name): return len([x for x in self.messages() if x == attr_name])
